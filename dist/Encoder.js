...
class Encoder {
    ...
    writeBU64(value) {
        this.ensureBufferSizeToWrite(8);
        (0, int_1.setBUint64)(this.view, this.pos, value);
        this.pos += 8;
    }
    writeBI64(value) {
        this.ensureBufferSizeToWrite(8);
        (0, int_1.setBInt64)(this.view, this.pos, value);
        this.pos += 8;
    }
    writeU64(value) {
        this.ensureBufferSizeToWrite(8);
